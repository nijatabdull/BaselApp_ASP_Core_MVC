...
namespace BaselFinalProjectApp.Migrations
{
    ...
    [Migration("20181216111330_BildingDetailChanged3")]
    partial class BildingDetailChanged3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaselFinalProjectApp.Models.MainModel.AppUser", b =>
                {
                    ...
                    b.HasIndex("BillingDetailId")
                        .IsUnique()
                        .HasFilter("[BillingDetailId] IS NOT NULL");
            ...
            modelBuilder.Entity("BaselFinalProjectApp.Models.MainModel.CategoryLanguage", b =>
                {
            ...
            modelBuilder.Entity("BaselFinalProjectApp.Models.MainModel.ColorLanguage", b =>
                {
                    b.Property<int>("LanguageId");
                    ...
                    b.HasKey("LanguageId", "ColorId");

                    b.HasIndex("ColorId");

                    b.ToTable("ColorLanguage");
                });
            ...
            modelBuilder.Entity("BaselFinalProjectApp.Models.MainModel.ProductLanguage", b =>
                {
                    b.Property<int>("LanguageId");
            ...
            modelBuilder.Entity("BaselFinalProjectApp.Models.PageModel.HomePageModel.ContactAbout", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BaselFinalProjectApp.Models.PageModel.HomePageModel.ContactAboutLanguage", b =>
                {
                    b.Property<int>("LanguageId");
                    ...
                    b.HasKey("LanguageId", "ContactAboutId");

                    b.HasIndex("ContactAboutId");

                    b.ToTable("ContactAboutLanguage");
                });
            ...
            modelBuilder.Entity("BaselFinalProjectApp.Models.PageModel.HomePageModel.LatestNews", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BaselFinalProjectApp.Models.PageModel.HomePageModel.LatestNewsLanguage", b =>
                {
                    b.Property<int>("LanguageId");
                    ...
                    b.HasKey("LanguageId", "LatestNewsId");

                    b.HasIndex("LatestNewsId");

                    b.ToTable("LatestNewsLanguage");
                });
            ...
            modelBuilder.Entity("BaselFinalProjectApp.Models.PageModel.HomePageModel.PageAboutLanguage", b =>
                {
                    b.Property<int>("LanguageId");

                    b.Property<int>("PageAboutId");
                    ...
                    b.HasKey("LanguageId", "PageAboutId");

                    b.HasIndex("PageAboutId");

                    b.ToTable("PageAboutLanguage");
                });
            ...
            modelBuilder.Entity("BaselFinalProjectApp.Models.PageModel.HomePageModel.PersonAboutLanguage", b =>
                {
                    b.Property<int>("LanguageId");

                    b.Property<int>("PersonAboutId");

                    b.Property<string>("Description");

                    b.Property<string>("Work");

                    b.HasKey("LanguageId", "PersonAboutId");

                    b.HasIndex("PersonAboutId");

                    b.ToTable("PersonAboutLanguage");
                });
            ...
            modelBuilder.Entity("BaselFinalProjectApp.Models.MainModel.AppUser", b =>
                {
                    b.HasOne("BaselFinalProjectApp.Models.MainModel.BillingDetail", "BillingDetail")
                        .WithOne("AppUser")
                        .HasForeignKey("BaselFinalProjectApp.Models.MainModel.AppUser", "BillingDetailId");
            ...
            modelBuilder.Entity("BaselFinalProjectApp.Models.MainModel.Cart", b =>
                {
                    b.HasOne("BaselFinalProjectApp.Models.MainModel.AppUser", "AppUser")
                        .WithOne("Cart")
                        .HasForeignKey("BaselFinalProjectApp.Models.MainModel.Cart", "AppUserId");
                });
            ...
            modelBuilder.Entity("BaselFinalProjectApp.Models.PageModel.HomePageModel.ContactAboutLanguage", b =>
                {
                    b.HasOne("BaselFinalProjectApp.Models.PageModel.HomePageModel.ContactAbout", "ContactAbout")
                        .WithMany("ContactAboutLanguages")
                        .HasForeignKey("ContactAboutId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("BaselFinalProjectApp.Models.PageModel.HomePageModel.LatestNewsLanguage", b =>
                {
                    b.HasOne("BaselFinalProjectApp.Models.MainModel.Language", "Language")
                        .WithMany("LatestNewsLanguages")
                        .HasForeignKey("LanguageId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BaselFinalProjectApp.Models.PageModel.HomePageModel.LatestNews", "LatestNews")
                        .WithMany("LatestNewsLanguages")
            ...
            modelBuilder.Entity("BaselFinalProjectApp.Models.PageModel.HomePageModel.PageAboutLanguage", b =>
                {
                    b.HasOne("BaselFinalProjectApp.Models.MainModel.Language", "Language")
                        .WithMany("PageAboutLanguages")
                        .HasForeignKey("LanguageId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BaselFinalProjectApp.Models.PageModel.HomePageModel.PageAbout", "PageAbout")
                        .WithMany("PageAboutLanguages")
                        .HasForeignKey("PageAboutId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("BaselFinalProjectApp.Models.PageModel.HomePageModel.PersonAboutLanguage", b =>
                {
                    b.HasOne("BaselFinalProjectApp.Models.MainModel.Language", "Language")
                        .WithMany("PersonAboutLanguages")
                        .HasForeignKey("LanguageId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BaselFinalProjectApp.Models.PageModel.HomePageModel.PersonAbout", "PersonAbout")
                        .WithMany("PersonAboutLanguages")
                        .HasForeignKey("PersonAboutId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
